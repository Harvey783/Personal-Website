        ...
        <div class="row">
          <div class="col col-md-12">
            ...
            <div id="intro-div" class="card content-wrapper">
              ...
              <p class="text-center">
              Full-stack web developer skilled in HTML/CSS, Express, MongoDB, Node, JavaScript, React, Redux, and Ruby on Rails with marketing experience demonstrating the ability to create diverse content for complex products and services in unique industries.
              </p>
              <div class="row">
